...
const SimpleLetrasDisplay = ({ 
  ...
  // Limpar letras removendo apenas os acordes entre colchetes [C] [F] etc, mas mantendo o texto
  const cleanLyrics = (lyricsText) => {
    if (!lyricsText) return "Letra não disponível";
    
    // Remove apenas os padrões [C], [F], etc, mas mantém todo o resto
  ...
  return (
    <div className="letras-display-container">
      ...
      {/* Container das Letras - Simples e Limpo */}
      <div 
        ref={lyricsRef}
...
export default SimpleLetrasDisplay;